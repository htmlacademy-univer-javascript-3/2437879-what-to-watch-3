...
import {makeFakeComments, makeFakeFilmCard, makeFakeFilmsList, makeFakeGenres, makeFakePromoFilm} from '../../mocks/mock-data.ts';
import {getActiveGenre, getComments, getFilmCard, getFilms, getGenres, getIsDataLoading, getMoreLikeThis, getMyList, getPromoFilm} from './selectors.ts';
...
describe('FilmsSlice selectors', () => {
  ...
  it('should return films-slice list from state', () => {
